...
router.post("/register", [
    (0, express_validator_1.check)("firstName", "First Name is required").notEmpty().isString(),
    (0, express_validator_1.check)("lastName", "Last Name is required").notEmpty().isString(),
